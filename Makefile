...
#OPT_FLAG= -ansi-alias -O3 -xSKYLAKE-AVX512 -qopenmp -D__MIC__ -std=c++0x
OPT_FLAG= -ansi-alias -xSKYLAKE-AVX512 -qopenmp -D__MIC__ -std=c++0x -D__KNC__ -mkl -O3
#OPT_FLAG= -ansi-alias -xSKYLAKE-AVX512 -D__MIC__ -std=c++0x -D__KNC__ -D_SpMV_ESB_ -mkl -g
EXE= pava
...
#debug:
#	icpc -O0 -ansi-alias -xSKYLAKE-AVX512 -qopenmp spmv.cpp -o spmv.g -g
clean:
	rm *.o $(EXE)
